...
class L10nNlTaxReportSBRWizard(models.TransientModel):
    ...
    def _generate_general_codes_values(self, options):
        ...
        tax_consultant_order_to_xml = {
            'NBA': 'Nederlandse Beroepsorganisatie',
            'RB': 'Register Belastingadviseurs',
            'NOB': 'Nederlandse Orde van Belastingadviseurs',
            'NOAB': 'Nederlandse Orde van Administratieve en Belastingdeskundigen',
        }
        ...
        return {
            ...
            'DateTimeCreation': fields.Datetime.now().strftime("%Y-%m-%dT%H:%M:%S"),
            ...
            'ProfessionalAssociationForTaxServiceProvidersOrder': tax_consultant_order_to_xml.get(self.tax_consultant_order),
