...
class EstonianTaxReportTest(AccountSalesReportCommon):
    ...
    def setUpClass(cls, chart_template_ref='l10n_ee.l10nee_chart_template'):
        ...
        cls.taxes = {
            # Purchase Taxes
            'vat_in_24_g': cls.env['account.tax'].search([
                    ('name', '=', '24% G'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            'vat_in_24_s': cls.env['account.tax'].search([
                    ('name', '=', '24% S'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            'vat_in_24_partial': cls.env['account.tax'].with_context(active_test=False).search([
                    ('name', '=', '24% S'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            ...
            'vat_in_0_eu_g_24': cls.env['account.tax'].search([
                    ('name', '=', '0% EU G 24%'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            'vat_in_0_eu_s_24': cls.env['account.tax'].search([
                    ('name', '=', '0% EU S 24%'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            'vat_in_24_car': cls.env['account.tax'].search([
                    ('name', '=', '24% Car'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            'vat_in_24_car_part': cls.env['account.tax'].with_context(active_test=False).search([
                    ('name', '=', '24% Car 50%'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            'vat_in_24_assets': cls.env['account.tax'].with_context(active_test=False).search([
                    ('name', '=', '24% Fixed Assets'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            ...
            'vat_in_24_imp_kms_38': cls.env['account.tax'].with_context(active_test=False).search([
                    ('name', '=', '24% EX KMS §38'),
                    ('type_tax_use', '=', 'purchase'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            ...
            'vat_in_0_kms_41_3': cls.env['account.tax'].with_context(active_test=False).search([
                    ('name', '=', '0% KMS §41¹'),
                    ('type_tax_use', '=', 'purchase'),
                    ('amount', '=', 24),
                    ('company_id', '=', cls.company_data['company'].id)
            ...
            # Sales Taxes
            'vat_out_24_g': cls.env['account.tax'].search([
                    ('name', '=', '24% G'),
                    ('type_tax_use', '=', 'sale'),
                    ('company_id', '=', cls.company_data['company'].id)
                ], limit=1),
            ...
            'vat_out_0_kms_41_3': cls.env['account.tax'].with_context(active_test=False).search([
                    ('name', '=', '0% KMS §41¹'),
                    ('type_tax_use', '=', 'sale'),
                    ('amount', '=', 24),
                    ('company_id', '=', cls.company_data['company'].id)
        ...
        cls.taxes['vat_in_24_partial'].l10n_ee_kmd_inf_code = '11'
        ...
        moves = self.env['account.move'].create([
            {
                ...
                'invoice_line_ids': [
                    Command.create({
                        'name': 'PT1',
                        'price_unit': 500,
                        'tax_ids': self.taxes['vat_in_24_g'].ids
                    }),
                ],
            },
            {
                ...
                'invoice_line_ids': [
                    Command.create({
                        'name': 'PT1',
                        'price_unit': 500,
                        'tax_ids': self.taxes['vat_in_24_partial'].ids
                    }),
                    Command.create({
                        'name': 'PT2',
                        'price_unit': 300,
            ...
            },
            {
                ...
                'invoice_line_ids': [
                    Command.create({
                        'name': 'PT1',
                        'price_unit': 800,
                        'tax_ids': self.taxes['vat_in_0_eu_g_24'].ids
                    }),
                    Command.create({
                        'name': 'PT2',
                        'price_unit': 700,
                        'tax_ids': self.taxes['vat_in_0_eu_s_24'].ids
                    }),
                    Command.create({
                        'name': 'PT3',
                        'price_unit': 600,
                        'tax_ids': self.taxes['vat_in_24_car'].ids
                    }),
                    Command.create({
                        'name': 'PT4',
                        'price_unit': 500,
                        'tax_ids': self.taxes['vat_in_24_car_part'].ids
                    }),
                    Command.create({
                        'name': 'PT5',
                        'price_unit': 400,
                        'tax_ids': self.taxes['vat_in_24_assets'].ids
                    }),
                    Command.create({
                        'name': 'PT6',
                        'price_unit': 300,
                    ...
                    Command.create({
                        'name': 'PT7',
                        'price_unit': 200,
                        'tax_ids': self.taxes['vat_in_24_imp_kms_38'].ids
                    }),
                    Command.create({
                        'name': 'PT8',
                        'price_unit': 100,
                        'tax_ids': self.taxes['vat_in_0_kms_41_3'].ids
                    }),
                ],
            },
            {
                ...
                'invoice_line_ids': [
                    Command.create({
                        'name': 'PT1',
                        'price_unit': 500,
                        'tax_ids': self.taxes['vat_out_24_g'].ids
                    }),
                ],
            },
            {
            ...
            },
            {
                ...
                'invoice_line_ids': [
                    ...
                    Command.create({
                        'name': 'PT7',
                        'price_unit': 200,
                        'tax_ids': self.taxes['vat_out_0_kms_41_3'].ids
                    }),
                ],
            },
        ])
        ...
        expected_xml = """
            <vatDeclaration>
                ...
                <declarationBody>
                    ...
                    <sumPerPartnerSales>false</sumPerPartnerSales>
                    <sumPerPartnerPurchases>false</sumPerPartnerPurchases>
                    <transactions24>2600.00</transactions24>
                    <transactions9>300.00</transactions9>
                    <transactions5>200.00</transactions5>
                    <transactionsZeroVat>3150.00</transactionsZeroVat>
                    <euSupplyInclGoodsAndServicesZeroVat>1500.00</euSupplyInclGoodsAndServicesZeroVat>
                    ...
                    <exportZeroVat>1100.00</exportZeroVat>
                    <salePassengersWithReturnVat>500.00</salePassengersWithReturnVat>
                    <inputVatTotal>1309.00</inputVatTotal>
                ...
                <purchasesAnnex>
                    ...
                    <purchaseLine>
                        ...
                        <invoiceNumber>INV001</invoiceNumber>
                        <invoiceDate>2025-07-11</invoiceDate>
                        <invoiceSumVat>620.00</invoiceSumVat>
                        <vatInPeriod>120.00</vatInPeriod>
                    </purchaseLine>
                </purchasesAnnex>
            </vatDeclaration>
        """
