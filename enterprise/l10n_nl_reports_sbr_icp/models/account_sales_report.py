...
class DutchECSalesReportCustomHandler(models.AbstractModel):
    ...
    def _generate_codes_values(self, report, lines, options):
        ...
        for line in lines:
            ...
            if company_currency.compare_amounts(amount_product, 0) == 1:
            ...
            if company_currency.compare_amounts(amount_service, 0) == 1:
                ctx_id = update_icp_context(icp_contexts_map, country, vat)
            ...
            if company_currency.compare_amounts(amount_triangular, 0) == 1:
                ctx_id = update_icp_context(icp_contexts_map, country, vat)
