...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_mx_edi_get_invoice_cfdi_values(self, invoice):
        ...
        if invoice.l10n_mx_edi_post_time:
            cfdi_date = invoice.l10n_mx_edi_post_time
        else:
            cfdi_date = invoice._l10n_mx_edi_get_min_of_now_and_document_date()
    ...
    def _l10n_mx_edi_get_payment_cfdi_values(self, move):
        ...
        cfdi_values = {
            **self._l10n_mx_edi_get_common_cfdi_values(move),
            ...
            'cfdi_date': (move.l10n_mx_edi_post_time and move.l10n_mx_edi_post_time.replace(microsecond=0) or datetime(move.invoice_date.year, move.invoice_date.month, move.invoice_date.day, 23, 59, 0)).isoformat(),
