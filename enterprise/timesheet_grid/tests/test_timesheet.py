...
class TestTimesheetValidation(TestCommonTimesheet, MockEmail):
    ...
    def test_timesheet_timer_timezone_resilience(self):
        ...
        self.env['res.config.settings'].create({
            'timesheet_encode_uom_id': self.env.ref('uom.product_uom_hour'),
        ...
        def test_off_by_minus_one():
            yesterday_timesheet, today_timesheet = Timesheet.create([
                {
                    'name': '/',
                    'project_id': self.project_customer.id,
                    'task_id': self.task1.id,
        ...
        def test_off_by_positive_one():
            tomorrow_timesheet, today_timesheet = Timesheet.create([
                {
                    'name': '/',
                    'project_id': self.project_customer.id,
                    'task_id': self.task1.id,
