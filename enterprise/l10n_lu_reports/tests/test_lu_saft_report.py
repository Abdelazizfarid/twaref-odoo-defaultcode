...
class TestLuSaftReport(TestAccountReportsCommon):
    ...
    def test_saft_report_values(self):
        ...
        # print(self.env[report.custom_handler_model_name].with_context(skip_xsd=True).l10n_lu_export_saft_to_xml(options)['file_content'].decode('utf-8'))
               ...
               <AuditFile xmlns="urn:OECD:StandardAuditFile-Taxation/2.00">
                    <Header>
                        ...
                        <Company>
                            ...
                            <Contact>
                                <ContactPerson>
                                    <FirstName>___ignore___</FirstName>
                                    <LastName>___ignore___</LastName>
                                </ContactPerson>
